...
def try_native_component(component: adsk.fusion.Component):
    if native_component := component.nativeObject:
...
def list_all_templates():
    files_in_template_folder = os.listdir(fileconfig.templates)
    templates = [ os.path.splitext(file)[0]
                  for file in files_in_template_folder
